...
exports.sourceNodes = async (
  ...
  const response = await axios({
    method: "get",
    url: `https://bettv.tischtennislive.de/Export/default.aspx?LigaID=${leagueId}&Format=XML&SportArt=96&Area=Tabelle`,
    responseType: "text",
  })
...
exports.createPages = async ({ graphql, actions, reporter }) => {
  ...
  result.data.league.Ergebnistabelle.Content[0].Mannschaft.forEach(
    ({ Mannschaft }) => {
